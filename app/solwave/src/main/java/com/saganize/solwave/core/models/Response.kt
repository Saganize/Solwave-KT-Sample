...
sealed class Response<out T> {
    companion object {
        const val noInternetConnectionMessage =
            "Device seems to be offline. Please check your internet connection and try again"
        const val genericErrorMsg = "Something went wrong. Please try again."
        const val serverErrorMessage =
            "Unexpected error on contacting server. Please try again or contact support"
    }
